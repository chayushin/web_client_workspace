...
function test1() {
    ...
    console.log(3 - "a"); // NaN N (Not a Number)
    console.log(3 * "a"); // NaN N (Not a Number)
    console.log(3 / "a"); // NaN N (Not a Number)
    console.log(3 % "a"); // NaN N (Not a Number)
...
/**
 * 실습문제 : 사용자 입력값 더하기
 * value 값들은 어떤 type으로 입력됐던간에 string이다.
 */
function printSum() {
    ...
    if(isNaN(num1Val) || isNaN(num2Val)) {
        alert(`유요하나 숫자를 입력해주세요`);
        return; // 조기리턴
    }
    alert(`숫자1 + 숫자2 = ${Number(num1Val)+Number(num2Val)}입니다.`);
}
